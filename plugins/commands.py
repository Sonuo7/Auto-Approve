...
async def approve_new(client, m):
    ...
    try:
        ...
        try:
            await client.send_message(m.from_user.id, "{},\n\n𝖸𝗈𝗎𝗋 𝖱𝖾𝗊𝗎𝖾𝗌𝗍 𝖳𝗈 𝖩𝗈𝗂𝗇 {} 𝖺𝗌 𝖻𝖾𝖾𝗇 𝖠𝖼𝖼𝖾𝗉𝗍𝖾𝖽, **<blockquote>𝙿𝚘𝚠𝚎𝚛e𝚍 𝙱𝚢 ➥ <a href = 'https://t.me/alsamovies' >× ᏚᎧƝU⁣𓆩💞𓆪</a></blockquote>**".format(m.from_user.first_name, m.chat.title))
        except:
            pass
    except Exception as e:
        print(str(e))
